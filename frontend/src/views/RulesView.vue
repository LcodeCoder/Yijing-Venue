...
const steps = [
  ...
  { icon: Sparkles, title: '资源阶段', text: '灵力清空并按棋盘边长+1刷新：3×3为4点，4×4为5点，5×5为6点，不会跨回合累计。' },
  { icon: Layers3, title: '部署阶段', text: '部署/覆盖场地、驻扎单位、调防（1灵力移至相邻己方场）、筛牌（弃1抽1，每回合1次）。人机90秒/排位60秒。' },
  { icon: Swords, title: '争夺阶段', text: '选择未行动单位攻击射程内的敌方场地。夹击（≥2相邻己方场）战力+1。战力≥总守力即可夺取。' },
...
<template>
  <div class="content-page section-wrap rules-page">
    ...
    <section class="rules-grid">
      ...
      <article><span><Sparkles/></span><h3>棋盘灵力与气势</h3><p>每回合灵力等于棋盘边长+1，不积累。争夺成功气势+1、失败-1；气势满3层可免费发动1费术式。</p></article>
      <article><span><Shield/></span><h3>驻场与状态</h3><p>每场最多2单位。单位可撤离或花费1灵力调防至相邻己方场。动摇（被夺场）不可主动攻；扎根（连驻2回合）守力+1。</p></article>
      <article><span><RefreshCcw/></span><h3>攻击距离与夹击</h3><p>普通单位射程1。斥候2、夜航游侠3。目标被≥2块己方邻接场夹住时战力+1。邻接己方场结算额外+1分。</p></article>
